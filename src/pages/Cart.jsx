...
export default function Cart() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      {cartItems.length === 0 ? (
        <p>Kurven er tom. Gå til shoppen for at finde produkter!</p>
      ) : (
        <div>
            ...
            {cartItems.map((item) => (
              <li key={item.id} style={{ 
                ...
                <div>
                  ...
                  <button onClick={() => handleQuantityChange(item.id, item.quantity, 1)} style={{ marginRight: '5px' }}>+</button>
                  <button onClick={() => handleQuantityChange(item.id, item.quantity, -1)} style={{ marginRight: '10px' }}>-</button>
